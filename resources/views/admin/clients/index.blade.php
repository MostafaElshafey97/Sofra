                ...
                <tbody>
                    @foreach($clients as $client)
                        <tr>
                            ...
                            <td class = "text-center"><button id = {{$client->id}}    type = "button" class = "toggle-activate-button btn btn-block {{$client->is_active ? 'bg-gradient-success' : 'bg-gradient-secondary'}}">{{$client->is_active ? 'Active' : 'Not Active'}}</button></td> 
